...
/// Bilgi kartına bağlı metin notları — yerel, kullanıcı + lesson public_id.
class LessonCardNotesService extends ChangeNotifier {
  LessonCardNotesService._();
  static final LessonCardNotesService instance = LessonCardNotesService._();

  static const _kKey = 'lesson_card_notes_v1';
  ...
  String noteFor(String lessonId) => _notes[lessonId] ?? '';

  bool hasNote(String lessonId) => noteFor(lessonId).isNotEmpty;

  Future<void> save(String lessonId, String text) async {
    await initialize();
